...
class SingletonBase:
    """Mixin class implementing thread-safe Singleton pattern."""
...
class CostManager(SingletonBase, BaseModel):
    ...
    token_costs: dict[str, dict[str, float]] = (
        TOKEN_COSTS  # different model's token cost
    )
    ...
    def update_cost(self, prompt_tokens, completion_tokens, model):
        ...
        logger.info(
            ...
            f"Model: {model}, Current cost: ${cost:.3f}, prompt_tokens: {prompt_tokens}, completion_tokens: {completion_tokens}"
        )
...
class FireworksCostManager(CostManager):
    ...
    def update_cost(self, prompt_tokens: int, completion_tokens: int, model: str):
        ...
        logger.info(
            ...
            f"Model: {model}, Current cost: ${cost:.4f}, prompt_tokens: {prompt_tokens}, completion_tokens: {completion_tokens}"
        )
